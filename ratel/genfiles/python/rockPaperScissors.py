...
from ratel.src.python.utils import location_sharefile, prog, mpcPort, prime, sz, int_to_hex, hex_to_int, recover_input, fp, replay, mark_finish, read_db, write_db, bytes_to_int, bytes_to_list, bytes_to_dict, int_to_bytes, list_to_bytes, dict_to_bytes, execute_cmd, players
...
async def runCreateGame(server, log):
    ...
    if valid == 1:
        ...
        signedTx = server.web3.eth.account.sign_transaction(tx, private_key=server.account.privateKey)
